  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-14">
      <div className="text-center">
        <ShopFrontIllustration className="mx-auto h-32 w-auto" />
        <DemoBadge />
      ...
      {!submitted ? (
        <div className="mt-8 rounded-2xl border-2 border-sand-200 bg-white p-6">
          ...
          <input
            ...
            className="mt-3 w-full rounded-xl border-2 border-sand-300 px-3 py-2.5 text-sm focus:border-role-restaurant focus:outline-none focus:ring-1 focus:ring-role-restaurant"
          />
          ...
          <div className="mt-6 flex justify-between">
            <button
              ...
              disabled={step === 0}
              className="rounded-full border-2 border-sand-300 px-4 py-2 text-sm font-medium text-sand-700 hover:enabled:bg-sand-100 disabled:opacity-40"
            >
              Back
            </button>
            {!isLast ? (
        ...
        <div className="mt-8">
          ...
          <div className="mt-4 space-y-3">
            {DEMO_DONATE_RESULTS.map((r) => (
              <div key={r.zone} className="rounded-2xl border-2 border-sand-200 bg-white p-4">
