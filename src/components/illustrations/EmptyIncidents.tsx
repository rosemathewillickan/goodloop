  ...
  return (
    <svg viewBox="0 0 160 120" fill="none" className={className} aria-hidden="true">
      ...
      <path
        ...
        strokeWidth="3"
      />
      <path d="M68 56l8 8 16-16" stroke="var(--color-brand-700)" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="28" cy="38" r="4" fill="var(--color-sky-300)" />
      <circle cx="132" cy="32" r="5" fill="var(--color-sun-300)" />
      <circle cx="140" cy="52" r="3" fill="var(--color-accent-300)" />
    </svg>
  );
}
