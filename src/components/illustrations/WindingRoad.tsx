...
export function WindingRoad({ className = "" }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 400 1050" preserveAspectRatio="none" className={className} aria-hidden="true">
      ...
      <g opacity="0.9">
        <circle cx="230" cy="60" r="12" fill="var(--color-brand-200)" />
        <rect x="227" y="68" width="6" height="14" rx="2" fill="var(--color-sand-300)" />

        <circle cx="30" cy="250" r="10" fill="var(--color-brand-300)" />
        <rect x="27" y="257" width="6" height="12" rx="2" fill="var(--color-sand-300)" />

        <circle cx="360" cy="500" r="13" fill="var(--color-brand-200)" />
        <rect x="357" y="509" width="6" height="14" rx="2" fill="var(--color-sand-300)" />

        <circle cx="35" cy="760" r="11" fill="var(--color-brand-300)" />
        <rect x="32" y="768" width="6" height="12" rx="2" fill="var(--color-sand-300)" />
      </g>
      ...
      <circle cx="140" cy="360" r="4" fill="var(--color-sky-300)" />
      <circle cx="270" cy="600" r="4" fill="var(--color-berry-300)" />
      <circle cx="90" cy="900" r="4" fill="var(--color-accent-300)" />
    </svg>
  );
}
